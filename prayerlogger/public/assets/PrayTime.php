...
PrayerTime.php: Prayer Times Calculator (ver 1.2.2)
Copyright (C) 2007-2010 PrayerTimes.org
...
TERMS OF USE:
    ...
    with a link back to PrayerTimes.org.
...
User's Manual:
http://PrayerTimes.org/manual

Calculating Formulas:
http://PrayerTimes.org/calculation
...
//------------------------- Sample Usage --------------------------
    ...
    $PrayerTime->setCalcMethod($PrayerTime->ISNA);
    $times = $PrayerTime->getPrayerTimes(time(), 43, -80, -5);
...
class PrayerTime
{
    ...
    */
    ...
    function PrayerTime($methodID = 0)
    {
